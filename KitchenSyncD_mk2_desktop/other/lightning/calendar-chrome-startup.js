...
var listener = {
    onSocketAccepted: function(socket, transport) {
        var input = transport.openInputStream(Components.interfaces.nsITransport.OPEN_BLOCKING,0,0);
        var output = transport.openOutputStream(Components.interfaces.nsITransport.OPEN_BLOCKING, 0, 0);
